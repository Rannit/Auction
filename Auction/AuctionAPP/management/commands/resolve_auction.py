...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for auc in auct:
            auc.lifecycle = 'X'
            auc.save()
            send_mail('Auction finished.', "Your auction has finished.", 'no_repli@auction.com', [auc.seller.email,], fail_silently=False)
            ...
            #print mails
            send_mail('Auction Finished.', "An auction in which you have bid on is over.", 'no_repli@auction.com', mails, fail_silently=False)